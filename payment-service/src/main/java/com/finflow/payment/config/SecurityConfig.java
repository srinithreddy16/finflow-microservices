...
/**
 * OAuth2 resource server for the Payment Service. JWT validation with Keycloak {@code
 * realm_access.roles} mapped to {@code ROLE_*} authorities; same pattern as transaction-service.
 */
@Configuration
@EnableWebSecurity
@Profile("!itest")
